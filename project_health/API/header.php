...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li  ALIGN = "center" class="nav-item">
        ...
        <a class="collapse-item" href="../user/user_dashboard.php">
  ...
  <li class="nav-item active">
    ...
    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="../user/history.php">
        ...
        <a class="collapse-item" href="login.php">
          ...
          <a class="collapse-item" href="../user/Chronic Disease.php">
          <i class="fas fa-hospital"></i>
          <span>โรคประจำตัว</span></a>
